...
for ds_cnt,(x,y) in enumerate(datasets):
    ...
    for est_idx,kernel in enumerate(Kernel):
        ...
        #绘制支持向量
        ax.scatter(clf.support_vectors_[:,0],clf.support_vectors_[:,1],s=50,facecolors='none',zorder=0,edgecolors='k')#facecolors='none' 画为透明的
...
plt.show()
#可以观察到 rbf高斯径向基 在任何数据集上表现都不错，属于比较万能的核函数
#无论如何先试试高斯径向基，在各种情况下往往效果都很不错
#如果rbf效果不好。再试试其他核函数
#另外，多项式核函数poly多被用于图像处理中